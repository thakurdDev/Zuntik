...
@implementation HomeEventDetailVC
    ...
    [ZuntikServicesVC PostMethodWithApiMethod:@"removeEvent.php" Withparms:parameters WithSuccess:^(id response)
     {
         ...
         if ([strSuccess isEqualToString:@"1"])
         {
             ...
             [objDatabase deleteEventsCalsData_Userid_idAndstrEventKey:strUserID EventKey:strEventKey];

             alert = [[UIAlertView alloc] initWithTitle:@"Delete Event" message:@"Delete event successfully" delegate:self cancelButtonTitle:nil otherButtonTitles:@"OK", nil];
             alert.tag=102;
         }
         else
         {
